class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        // Set custom hitbox for each spike
        ...
        this.battery.forEach( battery => {
            battery.setScale( 0.02, 0.02);
        });


        // Set up player avatar
        my.sprite.player = this.physics.add.sprite(30, 345, "platformer_characters", "tile_0023.png");
        ...
        this.restartButton = this.add.text(480,300, 'Restart', {
            fontSize: '15px',
            color: '#fff',
            backgroundColor: '#000',
            padding: { x: 10, y: 5 }
    ...
    update() {
        // Update vision position (convert world to screen coords)
        ...
        // Handle Death-Case
        if (this.death && !this.respawnTimer) {
            ...
            my.vfx.walking.stop();
            this.respawnTimer = this.time.delayedCall(1500, () => {
        ...
        my.sprite.player.setMaxVelocity(this.maxSpeed, 1000); // x and y limits
    }
